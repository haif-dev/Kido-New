...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      profiles: {
        Row: {
          ...
          first_name: string
          id: string
          id_verification: Database["public"]["Enums"]["verification_status"]
          is_active: boolean
          last_name: string
          locale: string
          location: unknown
      ...
      sitter_profiles: {
        Row: {
          ...
          created_at: string
          criminal_record: Database["public"]["Enums"]["verification_status"]
          ...
          rating_count: number
          services: Database["public"]["Enums"]["sitter_service"][]
          updated_at: string
        }
        Insert: {
          age_groups?: Database["public"]["Enums"]["age_group"][]
        ...
        Relationships: [
          {
            foreignKeyName: "sitter_profiles_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Enums: {
      account_role: "sitter" | "parent" | "admin"
      age_group: "infant" | "toddler" | "preschool" | "school" | "teen"
      booking_status:
        | "pending"
        | "accepted"
        | "declined"
